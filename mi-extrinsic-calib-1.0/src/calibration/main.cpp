...
std::string scan_data = "/home/phyorch/PROJECT/mi-extrinsic-calib-1.0/data/scans";
...
{
    std::string config_file = "/home/phyorch/PROJECT/mi-extrinsic-calib-1.0/config/master.cfg";
    //parse arguments
    //char *config_file = parse_args (argc, argv);
    perls::Calibration calib = perls::Calibration(config_file);
